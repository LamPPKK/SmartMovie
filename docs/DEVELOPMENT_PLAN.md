...
- Rating Apple đã bổ sung đầy đủ 20 mức nửa điểm cho Movie/TV/Episode. Việc tiếp theo: Episode Detail phải đọc điểm đã chấm từ account, ưu tiên mutation local còn pending và kiểm tra reload/đổi tài khoản; hiện Apple mới đọc pending local. Xem [blocker account state](TMDB_COVERAGE.md).
