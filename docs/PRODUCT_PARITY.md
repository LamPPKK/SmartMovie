...
| PAR-PROGRESS-001 | Episode progress | Mark an episode or every listed episode in a season watched/unwatched, persist the state offline without a SmartMovie server, show season completion, and keep Favorite/Watchlist data intact through storage migration. |
