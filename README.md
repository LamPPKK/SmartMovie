...
- **Connect TMDb safely** through browser approval or TV QR without entering a password in SmartMovie. Browse paginated Movie/TV account recommendations, rate Movie/TV/Episode titles from 0.5 to 10 in half-point steps, and manage account library/lists with durable offline mutation retry. Existing remote episode-rating hydration on Apple remains an open [parity blocker](docs/TMDB_COVERAGE.md).
