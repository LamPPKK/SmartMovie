...
class TopRateViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    var topRateURL = "api.themoviedb.org/3/movie/top_rated?api_key=d5b97a6fad46348136d87b78895a0c06&page="
    var pageNumber: Int = 1 {
        didSet {
            topRateURL = "api.themoviedb.org/3/movie/top_rated?api_key=d5b97a6fad46348136d87b78895a0c06&page=\(pageNumber)"
        }
    }
